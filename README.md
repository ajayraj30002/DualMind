...
LLM-powered intent classification across 9 intent types — autonomously decides <em>how</em> to answer every query
...
|---|---|---|
| **Intent** | What the user wants (1 of 9 types) | `FACTUAL_LOOKUP`, `SUMMARIZE`, `CODE_REQUEST` |
